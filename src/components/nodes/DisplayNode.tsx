  ...
  return (
    <div className={`bg-white border-2 rounded-lg shadow-lg min-w-[280px] max-w-[400px] ${
      ...
      <div className="min-h-[100px]">
        <div className="p-3 text-center text-gray-500">
          <div className="text-sm font-medium">{String(contentType)} Content</div>
      ...
      <div className="p-3 bg-gray-50 border-t border-gray-200">
        <div className="grid grid-cols-2 gap-2 text-xs text-gray-600">
          ...
          {Boolean((styling as Record<string, unknown>)?.responsive) && <div>Responsive</div>}
